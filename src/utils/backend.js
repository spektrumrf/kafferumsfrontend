...
export function getLedgers(token, success, handleError) {
	httpGetAsync('http://localhost:25555/api/user/ledgers?token=' + token, (data, xmlHttp) => success(JSON.parse(data), xmlHttp), handleError);
}
